...
int32_t main(void)
{
    ...
    int32_t mouse_cell_idx = 0;
    int32_t update_frames = 0;

    char *test = slurp_file("./test.txt");
    printf("%s\n", test);
    ...
    while (!quit) {
        ...
        case SDL_MOUSEMOTION:
            ...
            int32_t mouse_row = mousex / CELL_SIZE % CELL_ROWS;
            int32_t mouse_col = mousey / CELL_SIZE % CELL_COLS;
